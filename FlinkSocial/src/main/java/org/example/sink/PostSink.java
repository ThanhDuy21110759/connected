...
public class PostSink implements SinkFunction<Post>, Serializable {
  ...
  private static final String SPRINGAI_URL = "http://34.126.161.244:8180/api/get-post";
  private static final String SEARCH_URL = "http://34.126.161.244:8000/receive-post";
